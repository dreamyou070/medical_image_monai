...
def main(args):
    ...
    train_loader, val_loader = get_dataloader(cache_dir=cache_dir,
    ...
    val_loss = train_aekl(model=model,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--training_ids",
                        help="../medical_data/")

    parser.add_argument("--validation_ids", help="Location of file with validation ids.")
    parser.add_argument("--config_file",
                        help="Location of file with validation ids.") # "/project/configs/stage1/aekl_v0.yaml"
