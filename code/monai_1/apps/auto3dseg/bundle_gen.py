...
class BundleAlgo(Algo):
    ...
    def pre_check_skip_algo(self, skip_bundlegen: bool = False, skip_info: str = "") -> tuple[bool, str]:
        """
        Analyse the data_module analysis report and check if the algorithm needs to be skipped.
    ...
    def set_data_stats(self, data_stats_files: str) -> None:
        """
        Set the data_module analysis report (generated by DataAnalyzer).
    ...
    def set_data_source(self, data_src_cfg: str) -> None:
        """
        Set the data_module source configuration file
    ...
    def fill_template_config(self, data_stats_filename: str, algo_path: str, **kwargs: Any) -> dict:
        ...
        training data_module and other factors. This API is provided to allow the creation of fully functioning config files.
        Return the records of filling template config: {"<config name>": {"<placeholder key>": value, ...}, ...}.

        Args:
            data_stats_filename: filename of the data_module stats report (generated by DataAnalyzer)

        Notes:
            Template filling is optional. The user can construct a set of pre-filled configs without replacing values
            by using the data_module analysis results. It is also intended to be re-implemented in subclasses of BundleAlgo
...
class BundleGen(AlgoGen):
    ...
    Args:
        ...
        data_stats_filename: the path to the data_module stats file (generated by DataAnalyzer).
        data_src_cfg_name: the path to the data_module source config YAML file. The config will be in a form of
    ...
    def set_data_stats(self, data_stats_filename: str) -> None:
        """
        Set the data_module stats filename
    ...
    def get_data_stats(self):
        """Get the filename of the data_module stats"""
        return self.data_stats_filename

    def set_data_src(self, data_src_cfg_name):
        """
        Set the data_module source filename
    ...
    def get_data_src(self):
        """Get the data_module source filename"""
