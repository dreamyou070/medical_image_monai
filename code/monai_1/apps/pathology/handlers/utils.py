...
def from_engine_hovernet(keys: KeysCollection, nested_key: str) -> Callable[[Any], Any]:
    ...
    If data_module is a list of nested dictionaries after decollating, extract nested value with expected keys and
    construct lists respectively, for example,
    if data_module is `[{"A": {"C": 1, "D": 2}, "B": {"C": 2, "D": 2}}, {"A":  {"C": 3, "D": 2}, "B":  {"C": 4, "D": 2}}]`,
    ...
    Args:
        ...
        nested_key: specified key to extract nested data_module from dictionary or decollated list of dictionaries.
