...
"""
Usage example:
    diffuser_module-cli fp16_safetensors --ckpt_id=openai/shap-e --fp16 --use_safetensors
"""
...
class FP16SafetensorsCommand(BaseDiffusersCLICommand):
    ...
    def __init__(self, ckpt_id: str, fp16: bool, use_safetensors: bool, use_auth_token: bool):
        self.logger = logging.get_logger("diffuser_module-cli/fp16_safetensors")
    ...
    def run(self):
        ...
        pipeline_class = getattr(import_module("diffuser_module"), pipeline_class_name)
        ...
        # Open the PR.
        commit_description = (
            "Variables converted by the [`diffuser_module`' `fp16_safetensors`"
