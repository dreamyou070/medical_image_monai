...
def get_logger(name: Optional[str] = None) -> logging.Logger:
    ...
    This function is not supposed to be directly accessed unless you are writing a custom diffuser_module module.
    """
...
def get_verbosity() -> int:
    ...
    Returns:
        `int`:
            ...
            - `50`: `diffuser_module.logging.CRITICAL` or `diffuser_module.logging.FATAL`
            - `40`: `diffuser_module.logging.ERROR`
            - `30`: `diffuser_module.logging.WARNING` or `diffuser_module.logging.WARN`
            - `20`: `diffuser_module.logging.INFO`
            - `10`: `diffuser_module.logging.DEBUG`
...
def set_verbosity(verbosity: int) -> None:
    ...
    Args:
        verbosity (`int`):
            ...
            - `diffuser_module.logging.CRITICAL` or `diffuser_module.logging.FATAL`
            - `diffuser_module.logging.ERROR`
            - `diffuser_module.logging.WARNING` or `diffuser_module.logging.WARN`
            - `diffuser_module.logging.INFO`
            - `diffuser_module.logging.DEBUG`
    """
