...
def nightly(test_case):
    """
    Decorator marking a test that runs nightly in the diffuser_module CI.
...
class CaptureLogger:
    ...
    Example:
    ```python
    >>> from diffuser_module import logging
    >>> from diffuser_module.testing_utils import CaptureLogger

    >>> msg = "Testing 1, 2, 3"
    >>> logging.set_verbosity_info()
    >>> logger = logging.get_logger("diffuser_module.pipelines.stable_diffusion.pipeline_stable_diffusion.py")
