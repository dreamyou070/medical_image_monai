...
class UNetMotionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    # Copied from diffuser_module.models.unet_3d_condition.UNet3DConditionModel.enable_forward_chunking
    ...
    # Copied from diffuser_module.models.unet_3d_condition.UNet3DConditionModel.disable_forward_chunking
