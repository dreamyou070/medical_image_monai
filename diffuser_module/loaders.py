        ...
        for key in lora_keys:
            ...
            if lora_name.startswith("lora_unet_"):
                ...
                if "self_attn" in diffusers_name:
                    ...
                    # Be aware that this is the new diffuser_module convention and the rest of the code might
                    # not utilize it yet.
...
class FromSingleFileMixin:
    ...
    def from_ckpt(cls, *args, **kwargs):
        deprecation_message = "The function `from_ckpt` is deprecated in favor of `from_single_file` and will be removed in diffuser_module v.0.21. Please make sure to use `StableDiffusionPipeline.from_single_file(...)` instead."
    ...
    def from_single_file(cls, pretrained_model_link_or_path, **kwargs):
        ...
        # Code based on diffuser_module.pipelines.pipeline_utils.DiffusionPipeline.from_pretrained
...
class FromOriginalControlnetMixin:
    ...
    def from_single_file(cls, pretrained_model_link_or_path, **kwargs):
        ...
        ```py
        from diffuser_module import StableDiffusionControlNetPipeline, ControlNetModel
