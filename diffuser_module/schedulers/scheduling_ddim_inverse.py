...
from diffuser_module.configuration_utils import ConfigMixin, register_to_config
from diffuser_module.schedulers.scheduling_utils import SchedulerMixin
from diffuser_module.utils import BaseOutput, deprecate


@dataclass
# Copied from diffuser_module.schedulers.scheduling_ddpm.DDPMSchedulerOutput with DDPM->DDIM
