...
class KDPM2AncestralDiscreteScheduler(SchedulerMixin, ConfigMixin):
    ...
    # Copied from diffuser_module.schedulers.scheduling_heun_discrete.HeunDiscreteScheduler.index_for_timestep
    ...
    # Copied from diffuser_module.schedulers.scheduling_heun_discrete.HeunDiscreteScheduler.add_noise
    def add_noise(
        self,
