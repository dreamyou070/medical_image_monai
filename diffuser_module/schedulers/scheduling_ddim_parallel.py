...
# Copied from diffuser_module.schedulers.scheduling_ddim.rescale_zero_terminal_snr
...
class DDIMParallelScheduler(SchedulerMixin, ConfigMixin):
    ...
    @register_to_config
    # Copied from diffuser_module.schedulers.scheduling_ddim.DDIMScheduler.__init__
    def __init__(
        self,
    ...
    # Copied from diffuser_module.schedulers.scheduling_ddim.DDIMScheduler.scale_model_input
    ...
    # Copied from diffuser_module.schedulers.scheduling_ddim.DDIMScheduler.set_timesteps
