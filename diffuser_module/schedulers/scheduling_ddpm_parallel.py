...
@dataclass
# Copied from diffuser_module.schedulers.scheduling_ddpm.DDPMSchedulerOutput
...
class DDPMParallelScheduler(SchedulerMixin, ConfigMixin):
    ...
    @register_to_config
    # Copied from diffuser_module.schedulers.scheduling_ddpm.DDPMScheduler.__init__
    def __init__(
        self,
    ...
    # Copied from diffuser_module.schedulers.scheduling_ddpm.DDPMScheduler.scale_model_input
    ...
    # Copied from diffuser_module.schedulers.scheduling_ddpm.DDPMScheduler.set_timesteps
    def set_timesteps(
        self,
    ...
    # Copied from diffuser_module.schedulers.scheduling_ddpm.DDPMScheduler._get_variance
    ...
    # Copied from diffuser_module.schedulers.scheduling_ddpm.DDPMScheduler.add_noise
    def add_noise(
        self,
    ...
    # Copied from diffuser_module.schedulers.scheduling_ddpm.DDPMScheduler.get_velocity
    def get_velocity(
    ...
    # Copied from diffuser_module.schedulers.scheduling_ddpm.DDPMScheduler.previous_timestep
