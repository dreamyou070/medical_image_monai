...
class DPMSolverSDEScheduler(SchedulerMixin, ConfigMixin):
    ...
    # copied from diffuser_module.schedulers.scheduling_euler_discrete._sigma_to_t
    ...
    # copied from diffuser_module.schedulers.scheduling_euler_discrete._convert_to_karras
