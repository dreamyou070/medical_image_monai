...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        >>> from diffuser_module import KandinskyV22Pipeline, KandinskyV22PriorPipeline
        >>> import torch
...
EXAMPLE_INTERPOLATE_DOC_STRING = """
    Examples:
        ```py
        >>> from diffuser_module import KandinskyV22PriorPipeline, KandinskyV22Pipeline
...
class KandinskyV22PriorPipeline(DiffusionPipeline):
    ...
    # Copied from diffuser_module.pipelines.kandinsky.pipeline_kandinsky_prior.KandinskyPriorPipeline.get_zero_embed
    ...
    # Copied from diffuser_module.pipelines.kandinsky.pipeline_kandinsky_prior.KandinskyPriorPipeline._encode_prompt
    def _encode_prompt(
        self,
        prompt,
        device,
