...
# Modified from diffuser_module.models.attention.BasicTransformerBlock
...
class UniDiffuserBlock(nn.Module):
    ...
    def forward(
        ...
        # Following the diffuser_module transformer block implementation, put the LayerNorm on the
        # residual backbone
        # Pre-LayerNorm
        if self.pre_layer_norm:
            if self.use_ada_layer_norm:
...
# Modified from diffuser_module.models.transformer_2d.Transformer2DModel
