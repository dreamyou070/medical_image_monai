...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        >>> from diffuser_module import MusicLDMPipeline
        >>> import torch
        >>> import scipy
...
class MusicLDMPipeline(DiffusionPipeline):
    ...
    # Copied from diffuser_module.pipelines.audioldm.pipeline_audioldm.AudioLDMPipeline.mel_spectrogram_to_waveform
    ...
    # Copied from diffuser_module.pipelines.audioldm2.pipeline_audioldm2.AudioLDM2Pipeline.score_waveforms
    ...
    # Copied from diffuser_module.pipelines.audioldm.pipeline_audioldm.AudioLDMPipeline.check_inputs
    def check_inputs(
        self,
        prompt,
        audio_length_in_s,
    ...
    # Copied from diffuser_module.pipelines.audioldm.pipeline_audioldm.AudioLDMPipeline.prepare_latents
