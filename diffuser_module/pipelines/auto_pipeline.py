...
class AutoPipelineForText2Image(ConfigMixin):
    ...
    def from_pretrained(cls, pretrained_model_or_path, **kwargs):
        ...
        ```py
        >>> from diffuser_module import AutoPipelineForText2Image
    ...
    def from_pipe(cls, pipeline, **kwargs):
        ...
        ```py
        >>> from diffuser_module import AutoPipelineForText2Image, AutoPipelineForImage2Image
...
class AutoPipelineForInpainting(ConfigMixin):
    ...
    def from_pretrained(cls, pretrained_model_or_path, **kwargs):
        ...
        ```py
        >>> from diffuser_module import AutoPipelineForInpainting
    ...
    def from_pipe(cls, pipeline, **kwargs):
        ...
        ```py
        >>> from diffuser_module import AutoPipelineForText2Image, AutoPipelineForInpainting
