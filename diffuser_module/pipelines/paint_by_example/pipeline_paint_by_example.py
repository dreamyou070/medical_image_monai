...
class PaintByExamplePipeline(DiffusionPipeline):
    ...
    # Copied from diffuser_module.pipelines.stable_diffusion.pipeline_stable_diffusion_image_variation.StableDiffusionImageVariationPipeline.check_inputs
    ...
    def __call__(
        ...
        >>> from diffuser_module import PaintByExamplePipeline
