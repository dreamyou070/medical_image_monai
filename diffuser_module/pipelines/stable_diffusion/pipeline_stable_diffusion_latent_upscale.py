...
# Copied from diffuser_module.pipelines.stable_diffusion.pipeline_stable_diffusion_upscale.preprocess
...
class StableDiffusionLatentUpscalePipeline(DiffusionPipeline, FromSingleFileMixin):
    ...
    # Copied from diffuser_module.pipelines.stable_diffusion.pipeline_stable_diffusion_upscale.StableDiffusionUpscalePipeline.prepare_latents
    ...
    def __call__(
        ...
        Examples:
        ```py
        >>> from diffuser_module import StableDiffusionLatentUpscalePipeline, StableDiffusionPipeline
        >>> import torch
