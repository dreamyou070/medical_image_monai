...
EXAMPLE_DOC_STRING = """
        ...
        >>> from diffuser_module import StableDiffusionDiffEditPipeline
...
# Copied from diffuser_module.pipelines.stable_diffusion.pipeline_stable_diffusion_img2img.preprocess
def preprocess(image):
    deprecation_message = "The preprocess method is deprecated and will be removed in diffuser_module 1.0.0. Please use VaeImageProcessor.preprocess(...) instead"
...
class StableDiffusionDiffEditPipeline(DiffusionPipeline, TextualInversionLoaderMixin, LoraLoaderMixin):
    ...
    # Copied from diffuser_module.pipelines.stable_diffusion.pipeline_stable_diffusion.StableDiffusionPipeline.prepare_latents
    ...
    # Copied from diffuser_module.pipelines.stable_diffusion.pipeline_stable_diffusion_pix2pix_zero.StableDiffusionPix2PixZeroPipeline.prepare_image_latents
