...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        >>> from diffuser_module import StableUnCLIPImg2ImgPipeline
...
class StableUnCLIPImg2ImgPipeline(DiffusionPipeline, TextualInversionLoaderMixin, LoraLoaderMixin):
    ...
    # Copied from diffuser_module.pipelines.stable_diffusion.pipeline_stable_unclip.StableUnCLIPPipeline.noise_image_embeddings
