...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        >>> from diffuser_module import IFImg2ImgPipeline, IFImg2ImgSuperResolutionPipeline, DiffusionPipeline
...
class IFImg2ImgSuperResolutionPipeline(DiffusionPipeline, LoraLoaderMixin):
    ...
    # Copied from diffuser_module.pipelines.deepfloyd_if.pipeline_if_img2img.IFImg2ImgPipeline.prepare_intermediate_images
