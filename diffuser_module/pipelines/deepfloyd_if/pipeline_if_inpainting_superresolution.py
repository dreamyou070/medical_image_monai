...
# Copied from diffuser_module.pipelines.deepfloyd_if.pipeline_if_img2img.resize
...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        >>> from diffuser_module import IFInpaintingPipeline, IFInpaintingSuperResolutionPipeline, DiffusionPipeline
        >>> from diffuser_module.utils import pt_to_pil
        >>> import torch
...
class IFInpaintingSuperResolutionPipeline(DiffusionPipeline, LoraLoaderMixin):
    ...
    # Copied from diffuser_module.pipelines.deepfloyd_if.pipeline_if.IFPipeline.remove_all_hooks
    ...
    # Copied from diffuser_module.pipelines.deepfloyd_if.pipeline_if.IFPipeline._text_preprocessing
    ...
    # Copied from diffuser_module.pipelines.deepfloyd_if.pipeline_if.IFPipeline._clean_caption
    ...
    @torch.no_grad()
    # Copied from diffuser_module.pipelines.deepfloyd_if.pipeline_if.IFPipeline.encode_prompt
    def encode_prompt(
        self,
    ...
    # Copied from diffuser_module.pipelines.deepfloyd_if.pipeline_if.IFPipeline.run_safety_checker
    ...
    # Copied from diffuser_module.pipelines.deepfloyd_if.pipeline_if.IFPipeline.prepare_extra_step_kwargs
    ...
    # Copied from diffuser_module.pipelines.deepfloyd_if.pipeline_if_img2img.IFImg2ImgPipeline.preprocess_image with preprocess_image -> preprocess_original_image
    ...
    # Copied from diffuser_module.pipelines.deepfloyd_if.pipeline_if_superresolution.IFSuperResolutionPipeline.preprocess_image
    ...
    # Copied from diffuser_module.pipelines.deepfloyd_if.pipeline_if_inpainting.IFInpaintingPipeline.preprocess_mask_image
    ...
    # Copied from diffuser_module.pipelines.deepfloyd_if.pipeline_if_img2img.IFImg2ImgPipeline.get_timesteps
    ...
    # Copied from diffuser_module.pipelines.deepfloyd_if.pipeline_if_inpainting.IFInpaintingPipeline.prepare_intermediate_images
