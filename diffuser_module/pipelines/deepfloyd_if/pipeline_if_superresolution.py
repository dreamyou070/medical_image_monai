...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        >>> from diffuser_module import IFPipeline, IFSuperResolutionPipeline, DiffusionPipeline
...
class IFSuperResolutionPipeline(DiffusionPipeline, LoraLoaderMixin):
    ...
    # Copied from diffuser_module.pipelines.deepfloyd_if.pipeline_if.IFPipeline.prepare_intermediate_images
