...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        >>> from diffuser_module import ConsistencyModelPipeline

        >>> device = "cuda"
        >>> # Load the cd_imagenet64_l2 checkpoint.
        >>> model_id_or_path = "openai/diffuser_module-cd_imagenet64_l2"
...
class ConsistencyModelPipeline(DiffusionPipeline):
    ...
    # Follows diffuser_module.VaeImageProcessor.postprocess
    def postprocess_image(self, sample: torch.FloatTensor, output_type: str = "pil"):
        ...
        # Equivalent to diffuser_module.VaeImageProcessor.denormalize
        sample = (sample / 2 + 0.5).clamp(0, 1)
        if output_type == "pt":
            return sample

        # Equivalent to diffuser_module.VaeImageProcessor.pt_to_numpy
