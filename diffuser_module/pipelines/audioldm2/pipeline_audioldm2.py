...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        >>> import scipy
        >>> import torch
        >>> from diffuser_module import AudioLDM2Pipeline
...
class AudioLDM2Pipeline(DiffusionPipeline):
    ...
    # Copied from diffuser_module.pipelines.stable_diffusion.pipeline_stable_diffusion.StableDiffusionPipeline.prepare_latents with width->self.vocoder.config.model_in_dim
