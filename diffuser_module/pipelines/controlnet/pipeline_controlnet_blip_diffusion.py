...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        >>> from diffuser_module.pipelines import BlipDiffusionControlNetPipeline
...
class BlipDiffusionControlNetPipeline(DiffusionPipeline):
    ...
    # Copied from diffuser_module.pipelines.consistency_models.pipeline_consistency_models.ConsistencyModelPipeline.prepare_latents
    ...
    # Adapted from diffuser_module.pipelines.controlnet.pipeline_controlnet.StableDiffusionControlNetPipeline.prepare_image
