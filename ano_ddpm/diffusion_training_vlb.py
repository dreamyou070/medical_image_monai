...
from ImprovedDDPM.improved_diffusion.script_util import create_gaussian_diffusion
    ...
    for epoch in tqdm_epoch:
        ...
        for step, data in progress_bar:
            ...
            if x_0.shape[0] != 0 and x_0.dim() == 4:
                ...
                loss = torch.nn.functional.mse_loss(noise_pred.float(), target.float(), reduction="none").mean(
                    dim=(1, 2, 3))
