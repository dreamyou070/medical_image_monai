...
def main(args):
    ...
    unet = unet.to(device)
    n_epochs = args.max_unet_train_epochs
    val_interval = 40
    scaler = GradScaler()
    global_step = 0
    args.max_train_steps = args.max_unet_train_epochs * math.ceil(len(train_loader))
    ...
    for epoch in range(n_epochs):
        ...
        for step, batch in progress_bar:
            ...
            loss_dict["lr/unet_training_lr"] = lr_scheduler.get_last_lr()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--max_unet_train_epochs", type=int, default=500)
